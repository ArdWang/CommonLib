...
public class ClockView extends View{
    ...
    private static getCurrentDate getCurrentDate;

    //private HandlerUtils.Holder holder;
    ...
    public ClockView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        //holder = new HandlerUtils.Holder((HandlerUtils.OnMsgListener) context);
    ...
    private void getDate(){
        ...
        getCurrentDate.currentDate(time);
    }

    public interface getCurrentDate{
        void currentDate(String date);
    }
     ...
     * @param dateClick
     */
    public void setDateClick(getCurrentDate dateClick,String df) {
        getCurrentDate = dateClick;
        this.df = df;
    }
}
